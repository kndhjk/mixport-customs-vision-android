...
data class BarcodeLookupResult(
    ...
    val customersStatus: String? = null,
    val mpiStatus: String? = null,
    val serverScanCount: Int = 0,
    val serverMatchedScanCount: Int = 0,
    val serverMismatchScanCount: Int = 0,
    val serverErrorScanCount: Int = 0,
    val serverLastScannedAt: String? = null,
    val serverLastMatchStatus: String? = null,
    val scannerTargetMode: String? = null,
    val scannerExpectedScanCount: Int? = null,
    val scannerCompletedScanCount: Int? = null,
    val scannerRemainingScanCount: Int? = null,
    val scannerRepeatMatchCount: Int? = null,
    val scannerIsComplete: Boolean? = null,
    val containerScanCount: Int? = null,
    val containerMatchedScanCount: Int? = null,
    val containerRowCount: Int? = null,
    val containerMatchedRowCount: Int? = null,
)
